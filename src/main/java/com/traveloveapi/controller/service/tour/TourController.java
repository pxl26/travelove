...
public class TourController {
    ...
    @PostMapping("/new")
    @Tag(name = "SPRINT 2")
    public ServiceDetailDTO createService(@RequestBody CreateTourDTO req,@RequestParam MultipartFile[] files) throws IOException, InterruptedException {
        return tourService.createNewService(req.getService_type(), req.getTitle(), req.getDescription(), req.getHighlight(), req.getNote(), req.getCurrency(),req.getPimary_language(), files, req.getCity_id());
    }
