...
public class BillController {
    ...
    public ArrayList<BillEntity> getBill(@RequestParam(required = false) String tour_id, @RequestParam(required = false) Date from, @RequestParam Date to, @RequestParam(required = false) String status_code, @RequestParam(required = false) String owner_id) {
